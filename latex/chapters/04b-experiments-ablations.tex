...
\begin{tabular}{@{}lc@{}}
  \toprule
  What the descriptor-VLM sees & Mean IoU (egoexo) \\
  \midrule
...
\begin{table}
  ...
  \toprule
  Direction & Rank & Baseline band & Off & On & $\Delta$ \\
  \midrule
...
\vspace{4mm}
Each of these interventions localises a constraint without solving it. We discuss the findings, together with the need for a more discriminative grounding detector on the remaining slice of the waterfall where Grounding DINO boxes a correctly named object off target, into \cref{chap:conclusions}.