...
\begin{frame}{Pipeline overview}
  ...
  \begin{enumerate}
      ...
      \item Anchor Selection + Agentic Segmentation
      \item Prediction Propagation
  \end{enumerate}
\end{frame}
...
\begin{frame}{Stage 1: source frame selection}
  \begin{itemize}
    \item Pick the clearest seed frame by a visibility score.
  \end{itemize}
  \begin{center}
...
\begin{frame}{Stage 2: object description}
  \begin{itemize}
    \item Generate view- and time-independent description.
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{latex/imgs/ch3/pipeline_horizontal.png}
  \end{center}
...
\begin{frame}{Stage 3.1: Anchor Selection}
  \begin{itemize}
    \item Select anchor frames by Grounding DINO confidence in the destination.
    \end{itemize}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{latex/imgs/ch3/pipeline_horizontal.png}
  \end{center}
\end{frame}
...
\begin{frame}{Stage 3.2: Agentic Segmentation}
  \begin{itemize}
    \item SAM 3 agent loop simplifies, segments, and selects.
  \end{itemize}
  \begin{center}
...
\begin{frame}{Stage 4: propagation}
  \begin{itemize}
    \item SAM 2 memory tracker spreads predictions to all frames bidirectionally.
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{latex/imgs/ch3/pipeline_horizontal.png}
  \end{center}
...
\begin{frame}{Quantitative Results}
  \begin{itemize}
    \item Ours: 37.7 (Ego2Exo) / 40.6 (Exo2Ego) IoU.
    \item Last year challenge: ObjectRelator (35.3 / 40.3), O-Mama (42.6 / 44.1)
    \item Strongest comparable: V2-SAM (46.3 / 49.6).
