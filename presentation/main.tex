...
\begin{frame}{Task formulation}
  \begin{itemize}
    ...
    \item Two orthogonal sub-problems: (a) cross-view matching vs. (b) temporal completeness.
    \item Our approach: language bridge on (a), SAM 2 video tracking for (b).
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{latex/imgs/ch2/related-works.png}
  \end{center}
\end{frame}
...
\begin{frame}{Stage 1: source frame selection}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{latex/imgs/ch3/block-1-focus.png}
  \end{center}
\end{frame}
...
\begin{frame}{Stage 3.2: Agentic Segmentation}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{latex/imgs/ch3/block-3-2-focus.png}
  \end{center}
\end{frame}
...
\begin{frame}{Quantitative Results}
  \begin{itemize}
    ...
    \item Strongest published (fine-tuned on Ego-Exo4D): LM-EEC (54.98 / 65.77).
  \end{itemize}
\end{frame}
