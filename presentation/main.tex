  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item Matters for AR, robotics, and collaboration between agents.
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
  ...
  \begin{columns}
    \begin{column}{0.52\textwidth}
      \begin{itemize}
        ...
        \item \textbf{Weaknesses:} no cross-view ability on its own, so it must be embedded in a larger pipeline.
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
  ...
  \begin{columns}
    \begin{column}{0.52\textwidth}
      \begin{itemize}
        ...
        \item \textbf{Weaknesses:} limited precision under visual prompting.
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{Stage 3.2: Agentic Segmentation}
  \begin{itemize}
    \item Loop that iteratively proposes a prompt, generates candidates, validates, and selects.
  \end{itemize}
  \begin{center}
